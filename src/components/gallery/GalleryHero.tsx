    ...
    return (
        <section className="relative min-h-screen flex items-start justify-center pt-32">
            ...
            <div className="relative z-10 text-center text-white px-4">
                ...
                <p className="mt-8 justify-center">Explore our extensive portfolio of successful projects across the UAE and beyond. From towering </p>
                <p className="pt-2">commercial complexes to luxury residential developments, witness the quality and precision of</p>
                <p className="pt-2">Buildon's construction materials in action.</p>
                <a href="#gallery">
                <button className="mt-20 w-40  bg-yellow-400 text-black font-semibold py-2 
