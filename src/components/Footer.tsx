          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <p className="text-text-secondary text-sm  hover:text-primary hover:drop-shadow-lg transition-colors ease-in">+971 56 269 6505</p>
                </Link>
              </div>
              ...
              <div className="flex items-center">
                ...
                <p className="text-text-secondary text-sm  hover:text-primary hover:drop-shadow-lg transition-colors ease-in">info@buildontradingllc.com</p>
                </Link>
              </div>
            </div>
